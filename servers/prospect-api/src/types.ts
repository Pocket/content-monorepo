...
export enum MozillaAccessGroup {
  ...
  NEW_TAB_CURATOR_PLPL = 'mozilliansorg_pocket_new_tab_curator_plpl', // Access to pl-pl new tab in the corpus tool.
...
export enum ScheduledSurfaceGuidToMozillaAccessGroup {
  ...
  NEW_TAB_PL_PL = MozillaAccessGroup.NEW_TAB_CURATOR_PLPL,
