...
describe('Section', () => {
  ...
  describe('updateSection', () => {
    it('should update a Section & mark any associated active SectionItems in-active. ' +
      'Existing in-active SectionItems should not be updated.', async () => {
      ...
      sectionItem2 = await db.sectionItem.update({
        ...
        data: {active: false, deactivateSource: ActivitySource.ML}
      });
    ...
    it('should update a Section & set deactivateSource to ML if active is false', async () => {
      await createSectionHelper(db, {externalId: 'yu3ruib-123', title: 'New Title'});
